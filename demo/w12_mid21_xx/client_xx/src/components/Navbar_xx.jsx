...
const Navbar_xx = () => {
  const [isMobileMenuHidden, setIsMoblieMenuHidden] =useState(true);
  ...
  const handleMobileBtn =() =>{
    ...
    setIsMoblieMenuHidden(!isMobileMenuHidden);
  }
              ...
              <li className='menu-item dropdown'>
                ...
                <div className='sub-menu-wrapper slideInUp'>
                  <ul className='sub-menu'>
                    ...
                    <li className='menu-item'>
                      <Link to='/mid1Blog_xx'>Mid1: SupaBlog</Link>
                    </li>
                    <li className='menu-item'>
                      <Link to='/Mid2BlogLocal_xx'>Mid2: NodeBlogLocal</Link>
                    </li>
                    <li className='menu-item'>
